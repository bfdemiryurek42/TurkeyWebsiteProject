    ...
    public partial class CreateTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportantPeople", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportantPeople_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportantPeople_CityId",
                table: "ImportantPeople",
                column: "CityId");
        }
