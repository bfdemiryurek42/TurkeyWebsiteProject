...
namespace TurkeyWebsiteProject.Controllers
{
    public class FoodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Description")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Description")] Food food)
        {
            if (id != food.Id)
            {
                return NotFound();
